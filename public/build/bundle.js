...
var app = (function () {
    ...
    /* src/AppChart.svelte generated by Svelte v3.44.0 */

    const { console: console_1 } = globals;
    const file = "src/AppChart.svelte";
    ...
    // (180:40) {#each graphData as record}
    function create_each_block(ctx) {
    	...
    	function input0_input_handler() {
    		/*input0_input_handler*/ ctx[9].call(input0, /*each_value*/ ctx[21], /*record_index*/ ctx[22]);
    	}

    	function input1_input_handler() {
    		/*input1_input_handler*/ ctx[10].call(input1, /*each_value*/ ctx[21], /*record_index*/ ctx[22]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 181, 48, 7293);
    			attr_dev(span, "class", "input-group-text");
    			add_location(span, file, 182, 48, 7492);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "Server");
    			attr_dev(input1, "aria-label", "value");
    			add_location(input1, file, 183, 48, 7580);
    			attr_dev(div, "class", "input-group mb-3");
    			add_location(div, file, 180, 44, 7214);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, input0);
    			set_input_value(input0, /*record*/ ctx[20].key);
    			append_dev(div, t0);
    			append_dev(div, span);
    			append_dev(div, t2);
    			append_dev(div, input1);
    			set_input_value(input1, /*record*/ ctx[20].value);
    			append_dev(div, t3);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*graphData*/ 1 && input0.value !== /*record*/ ctx[20].key) {
    				set_input_value(input0, /*record*/ ctx[20].key);
    			}

    			if (dirty & /*graphData*/ 1 && to_number(input1.value) !== /*record*/ ctx[20].value) {
    				set_input_value(input1, /*record*/ ctx[20].value);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(180:40) {#each graphData as record}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("Current size: ");
    			t6 = text(/*maxWidth*/ ctx[3]);
    			t7 = text("px");
    			t8 = space();
    			p = element("p");
    			input0 = element("input");
    			...
    			add_location(h3, file, 133, 1, 3771);
    			...
    			add_location(canvas_1, file, 138, 16, 3969);
    			attr_dev(div0, "id", "myDiv");
    			attr_dev(div0, "class", "col-lg-7 border border-dark my-1 p-3 svelte-1f1yzvn");
    			add_location(div0, file, 137, 12, 3891);
    			attr_dev(button0, "class", button0_class_value = "accordion-button " + (/*editDetails*/ ctx[4].info ? '' : 'collapsed'));
    			...
    			add_location(button0, file, 153, 32, 4704);
    			attr_dev(h20, "class", "accordion-header");
    			attr_dev(h20, "id", "panelsStayOpen-headingOne");
    			add_location(h20, file, 152, 28, 4610);
    			attr_dev(label0, "for", "max-width");
    			add_location(label0, file, 163, 36, 5828);
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "name", "max-width");
    			attr_dev(input0, "id", "max-width");
    			attr_dev(input0, "min", "350");
    			attr_dev(input0, "max", "800");
    			attr_dev(input0, "step", "50");
    			add_location(input0, file, 165, 40, 5966);
    			add_location(p, file, 164, 36, 5922);
    			attr_dev(div1, "class", "accordion-body");
    			add_location(div1, file, 158, 32, 5312);
    			attr_dev(div2, "id", "panelsStayOpen-collapseOne");
    			attr_dev(div2, "class", div2_class_value = "accordion-collapse collapse " + (/*editDetails*/ ctx[4].info ? 'show' : ''));
    			attr_dev(div2, "aria-labelledby", "panelsStayOpen-headingOne");
    			add_location(div2, file, 157, 28, 5130);
    			attr_dev(div3, "class", "accordion-item");
    			add_location(div3, file, 151, 24, 4553);
    			attr_dev(button1, "class", button1_class_value = "accordion-button " + (/*editDetails*/ ctx[4].data ? '' : 'collapsed'));
    			...
    			add_location(button1, file, 172, 32, 6402);
    			attr_dev(h21, "class", "accordion-header");
    			attr_dev(h21, "id", "panelsStayOpen-headingTwo");
    			add_location(h21, file, 171, 28, 6309);
    			attr_dev(ul, "class", "list-group");
    			add_location(ul, file, 178, 36, 7078);
    			attr_dev(label1, "for", "");
    			attr_dev(label1, "class", "w-100");
    			add_location(label1, file, 188, 44, 7994);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "key");
    			attr_dev(input1, "aria-label", "key");
    			add_location(input1, file, 189, 44, 8091);
    			attr_dev(span, "class", "input-group-text");
    			add_location(span, file, 190, 44, 8237);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "value");
    			attr_dev(input2, "aria-label", "value");
    			add_location(input2, file, 191, 44, 8321);
    			add_location(button2, file, 192, 44, 8524);
    			attr_dev(div4, "class", "input-group mb-3");
    			add_location(div4, file, 187, 40, 7919);
    			attr_dev(div5, "class", "accordion-body");
    			add_location(div5, file, 177, 32, 7013);
    			attr_dev(div6, "id", "panelsStayOpen-collapseTwo");
    			attr_dev(div6, "class", div6_class_value = "accordion-collapse collapse " + (/*editDetails*/ ctx[4].data ? 'show' : ''));
    			attr_dev(div6, "aria-labelledby", "panelsStayOpen-headingTwo");
    			add_location(div6, file, 176, 28, 6829);
    			attr_dev(div7, "class", "accordion-item height-500 svelte-1f1yzvn");
    			add_location(div7, file, 170, 24, 6241);
    			attr_dev(div8, "class", "accordion");
    			attr_dev(div8, "id", "accordionPanelsStayOpenExample");
    			add_location(div8, file, 150, 20, 4469);
    			attr_dev(div9, "class", "border border-dark m-1 p-3");
    			add_location(div9, file, 142, 16, 4137);
    			attr_dev(div10, "class", "col-4");
    			add_location(div10, file, 141, 12, 4101);
    			attr_dev(div11, "class", "row");
    			add_location(div11, file, 136, 8, 3861);
    			attr_dev(div12, "class", "container");
    			add_location(div12, file, 135, 4, 3829);
    			attr_dev(main, "class", "svelte-1f1yzvn");
    			add_location(main, file, 132, 0, 3763);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, p);
    			append_dev(p, input0);
    			set_input_value(input0, /*maxWidth*/ ctx[3]);
    			append_dev(div8, t9);
    			...
    			set_input_value(input1, /*newValue*/ ctx[2].key);
    			append_dev(div4, t15);
    			append_dev(div4, span);
    			append_dev(div4, t17);
    			append_dev(div4, input2);
    			set_input_value(input2, /*newValue*/ ctx[2].value);
    			append_dev(div4, t18);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*addRecord*/ ctx[5](/*newValue*/ ctx[2], /*graphData*/ ctx[0], /*myChart*/ ctx[1]))) /*addRecord*/ ctx[5](/*newValue*/ ctx[2], /*graphData*/ ctx[0], /*myChart*/ ctx[1]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*editDetails*/ 16 && button0_class_value !== (button0_class_value = "accordion-button " + (/*editDetails*/ ctx[4].info ? '' : 'collapsed'))) {
    				attr_dev(button0, "class", button0_class_value);
    			}

    			if (dirty & /*maxWidth*/ 8) set_data_dev(t6, /*maxWidth*/ ctx[3]);

    			if (dirty & /*maxWidth*/ 8) {
    				set_input_value(input0, /*maxWidth*/ ctx[3]);
    			}

    			if (dirty & /*editDetails*/ 16 && div2_class_value !== (div2_class_value = "accordion-collapse collapse " + (/*editDetails*/ ctx[4].info ? 'show' : ''))) {
    				attr_dev(div2, "class", div2_class_value);
    			}

    			if (dirty & /*editDetails*/ 16 && button1_class_value !== (button1_class_value = "accordion-button " + (/*editDetails*/ ctx[4].data ? '' : 'collapsed'))) {
    			...
    			if (dirty & /*newValue*/ 4 && input1.value !== /*newValue*/ ctx[2].key) {
    				set_input_value(input1, /*newValue*/ ctx[2].key);
    			}

    			if (dirty & /*newValue*/ 4 && to_number(input2.value) !== /*newValue*/ ctx[2].value) {
    				set_input_value(input2, /*newValue*/ ctx[2].value);
    			}

    			if (dirty & /*editDetails*/ 16 && div6_class_value !== (div6_class_value = "accordion-collapse collapse " + (/*editDetails*/ ctx[4].data ? 'show' : ''))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let maxWidth = 500;
    	let editDetails = { info: false, data: false };
    	...
    	function input0_input_handler(each_value, record_index) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('chartInfo' in $$props) chartInfo = $$props.chartInfo;
    	};
    ...
    class AppChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
